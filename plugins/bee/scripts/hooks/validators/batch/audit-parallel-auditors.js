#!/usr/bin/env node
// audit-parallel-auditors.js — batch validator for /bee:audit Step 4
// (parallel-auditor wave). Dispatches the 10-agent roster (8 audit-family +
// audit-bug-detector + integration-checker) per BATCH_PER_INSERTION_AGENT_ROSTER,
